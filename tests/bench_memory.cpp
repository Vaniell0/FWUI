// Memory benchmark — measures RSS/heap for C++ FWUI tree operations.
//
// Build: cmake --build build --target fwui-bench-mem
// Run:   ./build/fwui-bench-mem
...
static Element build_dashboard(int n_widgets) {
    ...
    auto foot = footer({
        paragraph("FWUI Dashboard v1.0") | Color("#999") | FontSize(12),
    }) | Padding(20);
...
int main() {
    fmt::print("================================================================\n");
    fmt::print("FWUI C++ Memory Benchmark\n");
    fmt::print("================================================================\n\n");
