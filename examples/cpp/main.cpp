// FWUI C++ Example — Minimal HTML generation with pipe-operator DSL.
//
// Build:
...
int main() {
    ...
    auto title = h1("Hello from FWUI") | Bold() | Color("#1a1a2e") | Center();
    ...
    auto page = document("My Page",
        ...
        {                              // body
            ...
            div({
                ...
                h2("Projects") | Bold(),
                div({
                    card("FWUI", "C++20 HTML DSL with pipe-operator"),
